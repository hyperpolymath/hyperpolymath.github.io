...
// Replace hyperpolymath.github.io, Hyperpolymath.Github.Io — See README.adoc for details., just run, Hyperpolymath.Github.Io started successfully. with actuals
