...
# setup.sh — Universal setup script for hyperpolymath.github.io
#
# Detects your shell, platform, and installs prerequisites.
# Then hands off to `just setup` for project-specific configuration.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/hyperpolymath/hyperpolymath.github.io/main/setup.sh | sh
#   # or after cloning:
#   ./setup.sh
#
...
# ── Main ──
main() {
    printf "%s=== hyperpolymath.github.io Setup ===%s\n\n" "$BOLD" "$RESET"
    ...
    if [ ! -f "Justfile" ] && [ ! -f "justfile" ]; then
        ...
        info "Clone first: git clone https://github.com/hyperpolymath/hyperpolymath.github.io.git"
        info "Then: cd hyperpolymath.github.io && ./setup.sh"
        exit 1
    fi
